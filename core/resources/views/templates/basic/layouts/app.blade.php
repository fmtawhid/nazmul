...
<head>
    ...
    <title> {{  @$seoContents->social_title ?? @$seo->title ?? $pageTitle ?? '' }} - {{ gs()->siteName(__()) }} </title>
	...
	@stack('head')
        <script type="application/ld+json">
        {
            ...
            "@type": "WebSite",
            "name": "Bhola Mart Bangladesh",
            "url": "https://multitech.com.bd/",
            "logo": {
                "@type": "ImageObject",
                "url": "https://multitech.com.bd/assets/images/logo_icon/favicon.png",
                "width": 60,
                "height": 60
            },
            "potentialAction": {
